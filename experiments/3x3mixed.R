...
K <- c(3) # Number of node-groups
G <- c(3)  # Number of hyperedge-groups
...
write.csv(results, file = 'auc_outputs/em_estimates_k3g3.csv')
saveRDS(em_list, file = 'auc_outputs/em_hypergraph_k3g3.RDS')
