setwd('/data1/s3645177/tidy/difficult')
...
write.csv(results, file = 'auc_outputs/em_estimates_diff_200_200.csv')
saveRDS(em_list, file = 'auc_outputs/em_hypergraph_diff_200.RDS')
